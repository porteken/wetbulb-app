...
1)::real AS p90,
ROUND ((PERCENTILE_CONT (0.05) WITHIN GROUP (ORDER BY wetbulb))::numeric,
1)::real AS p5,
ROUND ((PERCENTILE_CONT (0.95) WITHIN GROUP (ORDER BY wetbulb))::numeric,
1)::real AS p95,
...
1)::real AS p90_avg,
ROUND ((PERCENTILE_CONT (0.05) WITHIN GROUP (ORDER BY wetbulb_avg))::numeric,
1)::real AS p5_avg,
ROUND ((PERCENTILE_CONT (0.95) WITHIN GROUP (ORDER BY wetbulb_avg))::numeric,
1)::real AS p95_avg
