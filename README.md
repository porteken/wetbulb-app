...
The `wetbulb_year_stats`, `wetbulb_forecast`, and `wetbulb_forecast_max` materialized views are queried
...
```sql
CREATE INDEX CONCURRENTLY IF NOT EXISTS wetbulb_year_stats_location_season_year_idx
ON public.wetbulb_year_stats (location_id, season, year);

CREATE INDEX CONCURRENTLY IF NOT EXISTS wetbulb_forecast_location_season_year_idx
ON public.wetbulb_forecast (location_id, season, year);

CREATE INDEX CONCURRENTLY IF NOT EXISTS wetbulb_forecast_max_location_season_year_idx
